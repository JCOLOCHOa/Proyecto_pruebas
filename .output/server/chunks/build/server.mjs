...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-BEN7mSim.mjs')
  },
  {
    name: "category",
    path: "/category",
    component: () => import('./category-9TiyeDJa.mjs')
  },
  {
    name: "nuevos",
    path: "/nuevos",
    component: () => import('./nuevos-CFAJ2yD6.mjs')
  },
  {
    name: "ofertas",
    path: "/ofertas",
    component: () => import('./ofertas-Di_Lvv2y.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-TnmjXGAX.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C1vCroyr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CxiTfa01.mjs'));
