  ...
  <div class="container">
    <header class="header">
      ...
      <nav class="header-nav">
        ...
        <router-link to="/about" class="nav-link active">Nosotros</router-link>
      </nav>
    </header>
    ...
    <div class="about-content">
      <div class="about-card">
        ...
        <p class="subtitle">
          Somos tu tienda de confianza en productos electrónicos de última generación
        </p>
        ...
        <div class="info-sections">
          <div class="info-box">
            ...
            <h3>Misión</h3>
            <p>Brindar productos tecnológicos de calidad al mejor precio del mercado</p>
          </div>
          ...
          <div class="info-box">
            ...
            <h3>Visión</h3>
            <p>Ser la tienda líder de electrónicos en Guatemala</p>
          </div>
          ...
          <div class="info-box">
            ...
            <h3>Valores</h3>
            <p>Calidad, honestidad y servicio al cliente</p>
          </div>
        </div>
      </div>
    </div>
...
.about-card {
  ...
  padding: 60px;
  text-align: center;
  box-shadow: 0 10px 40px rgba(13, 24, 33, 0.1);
  max-width: 800px;
  width: 100%;
...
.info-box:hover {
  ...
  border-color: #B4CDED;
  box-shadow: 0 10px 30px rgba(13, 24, 33, 0.1);
}
